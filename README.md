...
Исправлена ошибка в FBSDKCoreKit из-за которой на iOS 13 после успешного расшаривания информации передавалось событие соотвествующее отмене шаринга пользователем.
